...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [_NAVIGATION] = LAYOUT(
        ...
        _______, TG(3),   _______,                            _______,                            _______, _______, _______, _______, _______, _______
    ),

    [_MANAGEMENT] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
        _______, KC_VOLD, KC_VOLU, KC_MUTE, KC_MNXT, KC_MPRV, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
        _______, RGB_TOG, _______, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_MOD, _______, _______, _______, _______, _______,          _______,
        _______, _______, _______, _______, _______, _______, _______, RGB_SPI, RGB_SPD, _______, _______, _______,          _______,          _______,
        _______,          _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______,
...
void rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) {
    // Turn off RGB for all keys, since I don't care about it.
